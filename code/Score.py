...
from code.Const import C_YELLOW, SCORE_POS, C_BLACK, MENU_OPTION, C_WHITE
from code.DBProxy import DBProx
    ...
    def save(self, game_mode: str, player_score: list[int]):
        ...
        while True:
            ...
            if game_mode == MENU_OPTION[0]:
                ...
                text = 'Player 1 Enter name (4 chars max):'
            if game_mode == MENU_OPTION[1]:
                score = (player_score[0] + player_score[1]) / 2
                text = 'Enter Team name (4 chars max):'
            if game_mode == MENU_OPTION[2]:
                if player_score[0] >= player_score[1]:
                    score = player_score[0]
                    text = 'Enter Player 1 name (4 chars max):'
                else:
                    score = player_score[1]
                    text = 'Enter Player 2 name (4 chars max):'
